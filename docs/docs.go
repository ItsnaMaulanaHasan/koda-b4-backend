...
const docTemplate = `{
        ...
        "/admin/categories": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error while fetching or processing category data",
                        "schema": {
                            "$ref": "#/definitions/lib.ResponseError"
                        }
                    }
        ...
        "/admin/categories/{id}": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error while fetching category from database",
                        "schema": {
                            "$ref": "#/definitions/lib.ResponseError"
                        }
                    }
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error while deleting category data",
                        "schema": {
                            "$ref": "#/definitions/lib.ResponseError"
                        }
                    }
            ...
            "patch": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error while updating category data",
                        "schema": {
                            "$ref": "#/definitions/lib.ResponseError"
                        }
                    }
        ...
        "/admin/products": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error while fetching or processing product data.",
                        "schema": {
                            "$ref": "#/definitions/lib.ResponseError"
                        }
                    }
        ...
        "/admin/products/{id}": {
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error while deleting product data.",
                        "schema": {
                            "$ref": "#/definitions/lib.ResponseError"
                        }
                    }
        ...
        "/admin/products/{id}/images": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "Product image (JPEG/PNG, max 1MB)",
                        "name": "image",
                        "in": "formData",
                        "required": true
                    },
        ...
        "/admin/users": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error while fetching or processing user data",
                        "schema": {
                            "$ref": "#/definitions/lib.ResponseError"
                        }
                    }
        ...
        "/admin/users/{id}": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error while fetching users from database",
                        "schema": {
                            "$ref": "#/definitions/lib.ResponseError"
                        }
                    }
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error while deleting user data",
                        "schema": {
                            "$ref": "#/definitions/lib.ResponseError"
                        }
                    }
        ...
        "/carts": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error while fetching or processing carts data",
                        "schema": {
                            "$ref": "#/definitions/lib.ResponseError"
                        }
                    }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Data request add cart",
                        "name": "dataCart",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error while adding, updating, or get data from cart",
                        "schema": {
                            "$ref": "#/definitions/lib.ResponseError"
                        }
                    }
        ...
        "/carts/{id}": {
            "delete": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error while deleting cart data",
                        "schema": {
                            "$ref": "#/definitions/lib.ResponseError"
                        }
                    }
                ...
                "parameters": [
                    {
                        ...
                        "type": "integer",
                        "default": 4,
                        "description": "Limit of list favourite products",
                        "name": "limit",
                        "in": "query"
                    }
                ],
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "type": "array",
                                    "items": {
                                        "$ref": "#/definitions/models.PublicProductResponse"
                                    }
                                },
                                "limit": {
                                    "type": "integer"
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/models.OrderMethod"
                                            }
                                        }
                                    }
                                }
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.PublicProductDetailResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/profiles": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error while fetching profiles from database",
                        "schema": {
                            "$ref": "#/definitions/lib.ResponseError"
                        }
                    }
        ...
        "/transactions": {
            "post": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error while acces database",
                        "schema": {
                            "$ref": "#/definitions/lib.ResponseError"
                        }
                    }
    ...
    "definitions": {
        ...
        "models.HistoryDetail": {
            ...
            "properties": {
                ...
                "historyItems": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.HistoryItems"
                    }
                },
                "id": {
                    "type": "integer"
        ...
        "models.PublicProductDetailResponse": {
            "type": "object",
            "properties": {
                "Recomendations": {
                    "type": "array",
        ...
        "models.TransactionDetail": {
            ...
            "properties": {
                ...
                "transactionItems": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.TransactionItems"
                    }
                },
                "userId": {
                    "type": "integer"
